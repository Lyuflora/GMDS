...
namespace Gmds
{
    public class PanelManager : MonoBehaviour
    {
        ...
        public GameObject m_MorePopupWindow;
        ...
        public GameObject m_PortfolioPanel;
        ...
        {
            OpenPanel(PanelManager.m_Instance.m_MorePopupWindow);
        }
        public void OpenPortfolioPanel()
        {
            PortfolioPanel.m_Instance.RefreshPortfolioPanel();
            OpenPanel(PanelManager.m_Instance.m_PortfolioPanel);
        }
        public void CloseAllPanel()
        {
            ClosePanel(m_AttribPanel);
            ClosePanel(m_PopupPanel);
            ClosePanel(m_TechsPanel);
            ClosePanel(m_FriendsPanel);
            ClosePanel(m_ProjPanel);
            ClosePanel(m_ProjInfoPanel);
            ClosePanel(m_PortfolioPanel);
        }
...
;            /*GameStatus.m_Instance.UpdateProjRatings();*/
        ...
        IEnumerator SlideAnim()
        {
            ...
            GameStatus.m_Instance.UpdateProjRatings();
            CalendarManager.m_Instance.TriggerEndDialog();
        }
